...
export default function Navbar({ dark, onToggleTheme }) {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-6 top-4 z-50 mx-auto flex h-[72px] max-w-[1040px] items-center gap-3 rounded-[28px] border border-white/25 bg-black/35 px-3 text-white backdrop-blur-xl sm:inset-x-10 sm:px-4 lg:inset-x-14"
    >
      <a href="#business" data-nav-item className="flex h-14 w-24 shrink-0 items-center justify-center rounded-2xl px-2 transition-colors hover:bg-white/10 focus-visible:outline-3 focus-visible:outline-white sm:w-32">
        <img src="/logo.png" alt="Rudhram" className="h-11 w-full object-contain" />
      </a>
      ...
      <div className="hidden min-w-0 flex-1 items-center justify-center gap-1 md:flex">
        ...
        <div className="group relative" data-nav-item>
          ...
          <div className="pointer-events-none absolute left-0 top-full w-48 translate-y-1 pt-2 opacity-0 transition-[opacity,transform] group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:translate-y-0 group-focus-within:opacity-100">
            <div className="rounded-2xl border border-white/25 bg-black/60 p-2 backdrop-blur-xl">
      ...
      <button
        ...
        aria-pressed={dark}
        className="ml-auto flex h-12 w-12 shrink-0 cursor-pointer items-center justify-center rounded-full border border-white/20 transition-colors hover:bg-white/10 focus-visible:outline-3 focus-visible:outline-white md:ml-0"
      >
        <ThemeIcon dark={dark} />
      </button>
    </nav>
